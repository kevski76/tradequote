...
class PavingCalculator implements ModuleCalculator
{
    /**
     * Calculate paving item quantities and prices.
     *
     * Stub implementation — paving-specific rules to be added when the paving
